...
function fixture(patched=true){
 ...
 const cache=new Map();const context={ih:{c:n=>{if(!cache.has(n))cache.set(n,memo(n));return cache.get(n)}},Q:{jsx,jsxs:jsx,Fragment:'Fragment'},Y:()=>({data:undefined}),Fn:'Fn',hl:()=>null};
