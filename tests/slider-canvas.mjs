...
test('Decorative drawing follows every display frame at 60 and 120 Hz without uneven skips',()=>{for(const hz of [60,120]){const h=harness();for(let i=0;i<=hz;i++)h.tick(i*1000/hz);assert.equal(h.draws,hz+1);h.dispose()}});
