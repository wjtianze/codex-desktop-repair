...
const tests=['reader.mjs','composer.mjs','sidebar.mjs','transaction.cjs','patcher.cjs','new-helpers.mjs','installer-profile.cjs','project-sources.mjs','quick-actions.mjs','work-progress.mjs','deferred-save.mjs'];
