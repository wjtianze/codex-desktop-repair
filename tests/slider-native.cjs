...
function harness(kind){
 ...
 const jsx=(type,props)=>({type,props}),ctx={nt:{c:()=>cache},J:React,Y:{jsx,jsxs:jsx},s:()=>false,i:()=>({jump(){}}),o:()=>0,r:{span:'span'},l:'presence',ne:'track',te:'thumb',ee:'root',be:'canvas',De:'particles',ce:'fast',pe:'burst',p:'lock',W:new Proxy({},{get:(_,key)=>key}),window:{setTimeout:()=>1,clearTimeout(){}},queueMicrotask:()=>{},st:new Set(),wt:{previewIndex:null,previewBaseOptionId:null,previewOptionIds:[],maxBurstKey:0},Ct:30,St:160,WheelEvent:{DOM_DELTA_PIXEL:0}};
