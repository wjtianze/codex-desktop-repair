...
1.0.3 已通过 287 项本地行为测试，并逐项校验完整修复版的 8804 个打包资源。本次详情见 [Work 进度与下载修复](docs/WORK_PROGRESS_FIX.md)。实际安装和恢复结果见 [验证记录](docs/VALIDATION.md)，公开反馈的核对范围见 [排查说明](docs/AUDIT.md)。
