...
| 消息导航 | Chat、悬浮快速聊天和侧边聊天支持悬停预览、点击跳转；至少四条用户消息时显示，窄窗口预留导航空间 |
...
1.0.11 的主要变化见 [更新说明](docs/UPDATES_1_0_11.md)。适用版本与检查方法见 [兼容性与验证](docs/VALIDATION.md)，升级前也可以查看 [已知问题](docs/AUDIT.md)。
