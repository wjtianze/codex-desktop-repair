...
| 互动演示 | 修复旧格式演示的页签隐藏、布局和公式排版，保留整页滚动 |
...
1.0.4 已通过 304 项本地行为测试，并逐项校验完整修复版的 8805 个打包资源。本次详情见 [互动演示兼容修复](docs/VISUALIZATION_FIX.md)。实际安装和恢复结果见 [验证记录](docs/VALIDATION.md)，公开反馈的核对范围见 [排查说明](docs/AUDIT.md)。
